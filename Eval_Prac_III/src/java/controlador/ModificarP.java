...
public class ModificarP extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
      ...
      int idP = Integer.parseInt(request.getParameter("txtIdP")) ;
        ...
        if(producto.ModificarRegistroP()== true) {
            request.getRequestDispatcher("ModificadoP.jsp").forward(request, response);
        }else{
            request.getRequestDispatcher("noModificadoP.jsp").forward(request, response);
        }
    }
